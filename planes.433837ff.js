...
},{"./gsap-core.js":"TNS6","./CSSPlugin.js":"bp4Z"}],"Hyrg":[function(require,module,exports) {
"use strict";
...
var animation = /*#__PURE__*/_createClass(function animation() {
  ...
  var timelines = [t1, t2, t3, t4, t5, t6];
...
},{"gsap":"TpQl"}],"mNyN":[function(require,module,exports) {
"use strict";
...
},{}],"X5Vm":[function(require,module,exports) {
...
},{}],"GqRt":[function(require,module,exports) {
module.exports = "precision mediump float;\n#define GLSLIFY 1\n\nvarying vec3 vVertexPosition;\nvarying vec2 vTextureCoord;\n\nuniform sampler2D planeTexture;\n\nvoid main( void ) {\n    // just display our texture\n    gl_FragColor = texture2D(planeTexture, vTextureCoord);\n}";
},{}],"tLaX":[function(require,module,exports) {
"use strict";
...
var _vertexShader = _interopRequireDefault(require("../../../shaders/planes/vertexShader.glsl"));

var _fragmentShader = _interopRequireDefault(require("../../../shaders/planes/fragmentShader"));
...
var webgl = /*#__PURE__*/_createClass(function webgl() {
  ...
  window.addEventListener("load", function () {
    ...
    var planes = [];
    var scrollEffect = 0; // get our planes elements

    var planeElements = document.getElementsByClassName("plane"); // handle smooth scroll and update planes positions

    var smoothScroll = new _locomotiveScroll.default({
      el: document.getElementById('page-content'),
      smooth: true,
      inertia: 0.5,
      passive: true
    });
    var useNativeScroll = smoothScroll.isMobile; // set up our WebGL context and append the canvas to our wrapper

    var curtains = new _curtainsjs.Curtains({
      container: "canvas",
      watchScroll: useNativeScroll,
      // watch scroll on mobile not on desktop since we're using locomotive scroll
    ...
    curtains.onRender(function () {
      ...
      var delta = curtains.getScrollDeltas(); // invert value for the effect
      ...
      for (var i = 0; i < planes.length; i++) {
        ...
        applyPlanesParallax(i); // update the plane deformation uniform as well
    ...
    if (!useNativeScroll) {
      ...
      smoothScroll.on('scroll', function (obj) {
        updateScroll(obj.scroll.x, obj.scroll.y); // render scene
    ...
    var debugElement = document.getElementById("debug-value"); // we need to fill the counter with all our planes

    var planeDrawn = planeElements.length;
    var vs = _vertexShader.default;
    var fs = _fragmentShader.default;
    var params = {
      vertexShader: vs,
      fragmentShader: fs,
      widthSegments: 10,
    ...
    for (var i = 0; i < planeElements.length; i++) {
      var plane = new _curtainsjs.Plane(curtains, planeElements[i], params);
      planes.push(plane);
      handlePlanes(i);
    ...
    function handlePlanes(index) {
      ...
      plane.onReady(function () {
        ...
        applyPlanesParallax(index); // once everything is ready, display everything
        ...
        // apply the rotation
        plane.rotation.z = Math.abs(scrollEffect) / 750; // scale plane and its texture
        ...
        */
        ...
        planeDrawn++; // update our number of planes drawn debug value
    ...
    function applyPlanesParallax(index) {
      ...
      // get our window size
      var sceneBoundingRect = curtains.getBoundingRect(); // get our plane center coordinate

      var planeBoundingRect = planes[index].getBoundingRect();
      var planeOffsetTop = planeBoundingRect.top + planeBoundingRect.height / 2; // get a float value based on window height (0 means the plane is centered)

      var parallaxEffect = (planeOffsetTop - sceneBoundingRect.height / 2) / sceneBoundingRect.height; // apply the parallax effect
...
},{"curtainsjs":"aeXH","locomotive-scroll":"ez7q","../../../shaders/planes/vertexShader.glsl":"X5Vm","../../../shaders/planes/fragmentShader":"GqRt"}],"Hu2L":[function(require,module,exports) {
"use strict";
...
},{}],"EbPm":[function(require,module,exports) {
"use strict";
...
new _webgl.default();
},{"./animation":"Hyrg","./webgl":"tLaX","../../utils/transition":"Hu2L"}]},{},["EbPm"], null)